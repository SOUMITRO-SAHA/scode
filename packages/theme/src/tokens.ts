...
export const markdown = {
  ...
  bullet: colors.blue[400],
  bulletBold: colors.blue[300],
  ...
  task: {
    unchecked: colors.gray[400],
    checked: colors.green[400],
    checkedText: colors.gray[300],
  },
  callout: {
    note: colors.callout.note,
    noteBg: colors.callout.noteBg,
    noteIcon: colors.blue[400],
    tip: colors.callout.tip,
    tipBg: colors.callout.tipBg,
    tipIcon: colors.green[400],
    important: colors.callout.important,
    importantBg: colors.callout.importantBg,
    importantIcon: colors.purple[400],
    warning: colors.callout.warning,
    warningBg: colors.callout.warningBg,
    warningIcon: colors.yellow[400],
    caution: colors.callout.caution,
    cautionBg: colors.callout.cautionBg,
    cautionIcon: colors.red[400],
  },
  diff: {
    add: colors.diff.add,
    addBg: colors.diff.addBg,
    delete: colors.diff.delete,
    deleteBg: colors.diff.deleteBg,
    context: colors.diff.context,
